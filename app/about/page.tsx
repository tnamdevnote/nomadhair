...
function About() {
  return (
    <div className="flex flex-col gap-16 py-8">
      <Container className="">
        <h1 className="text-lg lg:text-2xl">About Me</h1>
      </Container>
      <SplitContainer
        leftWeight={1}
        rightWeight={1}
        className="md:flex-row-reverse md:items-start md:gap-8"
      >
        <SplitContainer.Left className="px-12 md:basis-1/3 md:px-0">
          <Image
            src={Profile}
            width={557}
            alt="Profile Image"
        ...
        <SplitContainer.Right className="flex flex-col gap-4 md:basis-2/3">
          <h2 className="text-center text-xl md:text-left lg:text-2xl">
          ...
          <Button className="min-w-0 md:w-fit">Contact Me</Button>
