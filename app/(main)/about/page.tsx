  ...
  return (
    <div className="flex flex-col gap-16 py-8 md:pb-32">
      ...
      <SplitContainer className="md:flex-row-reverse md:items-start md:gap-16">
        ...
        <SplitContainer.Right className="flex flex-col gap-10 md:basis-2/3">
          <h2 className="text-center text-lg text-primary-100 md:text-left md:text-lg">
            Happiness is a decision, not a destination. Realize it with us!
          </h2>
          <p className="text-center text-base text-neutral-70 md:text-left lg:text-base">
