...
const buttonVariants = cva(
  "inline-flex items-center gap-2 justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      intent: {
        primary: "bg-primary-100 text-white hover:bg-primary-90",
        secondary: "bg-secondary-100 text-neutral-90 hover:bg-secondary-90",
        tertiary: "bg-tertiary-100 text-neutral-90 hover:bg-tertiary-90",
        success: "bg-success-100 text-white hover:bg-success-90",
        danger: "bg-danger-100 text-white hover:bg-danger-90",
      },
      variant: {
        contained: undefined,
