...
function Header({ photo, isAuthenticated }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 z-10 flex h-navbar-height-sm w-full justify-center border-b-[0.5px] border-primary-10/90 bg-secondary-10 md:bg-transparent md:backdrop-blur-md">
